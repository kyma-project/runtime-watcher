...
// TODO implement functions: Store private key and store public key with key as input and client.client as k8sclient
...
func getPublicKeyReference(ctx context.Context,
	...
	if !ok {
		return types.NamespacedName{}, fmt.Errorf(keyMissingError, PrvtKeyKey)
	}
...
func getPrivateKey(ctx context.Context, privateKeyReference types.NamespacedName,
	...
	encodedPrvtKey, ok := pKeySecret.Data[PrvtKeyKey] // TODO maybe decryption is needed
	if !ok {
		return nil, fmt.Errorf(keyMissingError, PrvtKeyKey)
	}
